...
const Color primary = Color(0xff33B5E8);
const Color secondary = Color(0xff33b5e8);
const Color fontColor = Color(0xff4543C1);
const Color grad1Color = Color(0xff247fa2);
const Color grad2Color = Color(0xff5cc4ed);
