...
class StateProfile extends State<Profile> with TickerProviderStateMixin {
  ...
  getUserDetails() async {
    ...
    tax_number = await getPrefrence(taxNumber);
    pan_number = await getPrefrence(panNumber);
  ...
  Future<void> setPasswordUser() async {
    var parameter = {
      Id: CUR_USERID,
      Name: name,
      Mobile: mobile,
    ...
    if (newPass != null && newPass != "") {
      parameter[NEWPASS] = newPass;
    }
    if (curPass != null && curPass != "") {
      parameter[OLDPASS] = curPass;
    }
    apiBaseHelper.postAPICall(getUserLoginApi, parameter).then(
      (getdata) {
                ...
                new FlatButton(
                  ...
                  onPressed: () {
                    ...
                    if (form.validate()) {
                      ...
                      setSnackbar(
                          "Sorry! In Demo not allow to change Password!");
                      // checkNetwork();
                    }
                  },
                )
